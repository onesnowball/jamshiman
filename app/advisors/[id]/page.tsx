...
type AdvisorPageReview = Pick<
  AdvisorReview,
  'id' | 'degree_type' | 'ratings' | 'anonymized_text' | 'years_in_lab' | 'is_current' | 'created_at'
>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 page-enter">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Left: advisor info + write review */}
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="card p-5">
              ...
              <AdvisorReviewForm
                advisor={{ ...advisor, dept_name: advisor.departments?.name }}
              />
            </div>
          </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {review.years_in_lab && (
                      <span className="text-xs text-gray-400 flex items-center gap-1">
                        ...
                        {review.years_in_lab} yr{review.years_in_lab > 1 ? 's' : ''}
                      </span>
                    )}
                  </div>
