...
export function BoardPostForm({ deptId }: { deptId: string }) {
  ...
  return (
    <div className="card p-5 space-y-4">
      <div>
        <h2 className="font-medium text-gray-900">Start a thread</h2>
        <p className="text-sm text-gray-500 mt-1">
          Ask questions, share department context, or post what you wish incoming students knew.
        </p>
      </div>
      ...
      <textarea
        ...
        placeholder="What do you want to share with the department?"
        className="textarea"
      />
